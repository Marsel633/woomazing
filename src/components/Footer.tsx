...
export const Footer = () => {
  return (
    <footer className="h-[360px] bg-[#f1eadc]">
      <div className="h-full container mx-auto w-full grid grid-cols-4 justify-center items-center">
          ...
          <nav className="flex flex-col items-center gap-[40px] col-span-2">
          ...
          <div className="flex flex-col gap-[25px] items-end col-span-1">
            <p>+7 (495) 823-54-12</p>
